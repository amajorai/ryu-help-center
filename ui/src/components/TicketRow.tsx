...
export function TicketRow({ onSelect, selected, ticket }: TicketRowProps) {
	...
	return (
		<Button
			...
			className={`help-center-ticket-row group flex h-auto w-full items-start gap-3 border-border/70 border-b px-3 py-3 text-left outline-none transition-colors hover:bg-muted/50 focus-visible:bg-muted focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset ${selected ? "bg-primary/8" : ""}`}
