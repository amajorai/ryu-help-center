	...
	return (
		...
		>
			<div className="flex items-center gap-3">
				<span className="flex size-11 items-center justify-center rounded-2xl bg-primary/10 font-semibold text-primary ring-1 ring-primary/20">
					{initials(ticket.requester.name)}
				</span>
				<div className="min-w-0">
					<p className="truncate font-semibold">{ticket.requester.name}</p>
